...
DATA_TEXT_FILE = 'data_quant_dynamic_desktop.txt' # save the average database and query times to this file
...
db_time_quant_dynamic = measure_time_onnx(db_dataloader, ort_session, input_name, ITERATIONS, "Processing database dataset")
print(f"Database Average Time: {db_time_quant_dynamic}")

q_time_quant_dynamic = measure_time_onnx(q_dataloader, ort_session, input_name, ITERATIONS, "Processing query dataset")
